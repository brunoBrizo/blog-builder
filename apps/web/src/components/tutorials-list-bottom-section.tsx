...
import { ArrowRight, Mail, Mailbox } from 'lucide-react';
...
export function TutorialsListBottomSection() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      <div className="lg:col-span-8 bg-zinc-900 rounded-3xl p-6 md:p-8 border border-zinc-800 shadow-sm relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 group">
        ...
        <div className="relative z-10 flex-1 text-center md:text-left">
          ...
          <p className="text-sm font-light text-zinc-400 max-w-sm mx-auto md:mx-0 leading-relaxed">
            Join 25,000+ developers receiving our top architectural teardowns
            every Tuesday.
          </p>
        </div>
      ...
      <div className="lg:col-span-4 bg-zinc-900 rounded-3xl p-6 md:p-8 border border-zinc-800 shadow-sm relative overflow-hidden flex flex-col justify-between group">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-indigo-500 rounded-full blur-[80px] opacity-20 pointer-events-none group-hover:opacity-30 transition-opacity duration-700" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-violet-500 rounded-full blur-[80px] opacity-20 pointer-events-none group-hover:opacity-30 transition-opacity duration-700" />
        <div className="relative z-10 mb-8">
          <h2 className="text-xs font-medium text-zinc-400 uppercase tracking-widest mb-6">
            Lead Instructor
          </h2>
          {lead ? (
          ...
          <p className="text-sm font-light text-zinc-400 leading-relaxed">
            Curating step-by-step masterclasses and architectural blueprints to
            help developers scale faster and write cleaner code.
          </p>
        </div>
        <Link
          href="/tutorials"
